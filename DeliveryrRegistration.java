...
public class DeliveryrRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deliveryr_registration);
        Fname = (TextInputLayout) findViewById(R.id.FirstnameDev);
        Lname = (TextInputLayout) findViewById(R.id.LastNameDev);
        Email = (TextInputLayout) findViewById(R.id.EmailDev);
        Pass = (TextInputLayout) findViewById(R.id.PasswordDev);
        cpass = (TextInputLayout) findViewById(R.id.CopypasswordDev);
        mobileno = (TextInputLayout) findViewById(R.id.PhoneDev);
        Id = (TextInputLayout) findViewById(R.id.IDev);
        BirthDay = (TextInputLayout) findViewById(R.id.birthDev);


        databaseReference = firebaseDatabase.getInstance().getReference("Delevry");
        ...
        Signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(DeliveryrRegistration.this);
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        firebaseDatabase.getInstance().getReference("Customer")
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                mDialog.dismiss();
                                                Intent i=new Intent(DeliveryrRegistration.this,CustomerLogin.class);
                                                startActivity(i);
                                            }
                                        });
